...
/** OUT_OF_SCOPE 분류인데 근거 인용(D-X 표기·청크 id·청크 heading)이 있으면 위반이다. */
...
export function verifyAnswer(
  ...
  const checks = [
    ...
    checkCitedWhileOutOfScope(answer, category, evidence),
  ];
